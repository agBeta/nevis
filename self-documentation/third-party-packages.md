...
According to [helmet docs](https://helmetjs.github.io/faq/conditional-skip/) you can skip a header conditionally.   
According to [this SO answer](https://stackoverflow.com/a/65279253) you can set all of the defaults **except** for one.
