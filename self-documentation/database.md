...
Also [David Aldridge's answer](https://stackoverflow.com/a/617556) in the same post gives a very insightful explanation to *avoid* using numeric data types for elements *just because* they are comprised only of digits.
...
## pagination
According to https://mysql.rjweb.org/doc.php/pagination (Very detailed article even talking about <a> to use for frontend):
